...
class StateMachine:
    ...
    def __init__(self, rover):
        ...
        self.PathFollower  = PathFollower(rover, self)
        self.Search        = Search(rover, self)
        self.FinalApproach = FinalApproachPost(rover, self)

        self.states = [ s(rover) for s in [PathFollower, Search, FinalApproachPost]]
